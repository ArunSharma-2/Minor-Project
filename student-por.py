...
def plot_feature_importance(model, feature_names, title):
    ...
    plt.bar(range(len(sorted_importance)), sorted_importance, color='#4f81bd', align='center')
...
df = read_data('data/student-por.csv')
plot_grade_distribution(df, 'Student Por')
...
plot_model_comparison(model_names, rmses, r2_scores, 'Student Por')
...
plot_feature_importance(best_model, X.columns, f'{best_model_name} on Student Por')